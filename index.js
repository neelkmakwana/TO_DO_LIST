...
//Made By Neel Makwana
// task_input[0].addEventListener('keypress' , (e) => {
...
function deleteTodo(id) {
    ...
    saveToLocalStorage();
    showAlertMessage('To Do List Deleted Successfully', 'success');
    showAllTodos();
}
//Made By Neel Makwana
//edit todo
function editTodo(id) {
    ...
    add_btn.addEventListener('click', () => {
        ...
        showAlertMessage('To Do List Updated Successfully', 'success');
    });
}
//Made By Neel Makwana
//clear all todos
function clearAllTodos() {
    if(todos.length > 0) {
        todos = [];
        saveToLocalStorage();
        showAlertMessage('All To Do List Cleared Successfully', 'success');
        showAllTodos();
    }else{
        showAlertMessage('No To Do List to clear', 'error');
    }
}